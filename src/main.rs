...
fn setup_autos(mut comp: AutoHandler) -> AutoHandler {
    ...
    no.move_to_pose((0.0, 10.0, 0.0), 12.0);
    no.set_last_timeout(100.0);
    ...
    left_elims.move_to_pose((-30.0, 47.0, 270.0), 1.0);
    left_elims.reverse_last();
    ...
    left_elims.move_to_pose((-13.0, 13.0, 315.0), 1.0);
    left_elims.reverse_last();
    ...
    right_elims.move_to_pose((-30.0, -47.0, 270.0), 1.0);
    right_elims.reverse_last();
    ...
    left_qual.move_to_pose((-30.0, 47.0, 270.0), 1.0);
    left_qual.reverse_last();
    ...
    right_qual.move_to_pose((-30.0, -47.0, 270.0), 1.0);
    right_qual.reverse_last();
    ...
    sawp.move_to_pose((-30.0, -47.0, 270.0), 1.0);
    sawp.reverse_last();
    ...
    sawp.chain_move_to_pose((-24.0, -30.0, 0.0), (0.75, 1.0));
    sawp.add_action(Action::ToggleMatchload, 6.0);
    sawp.chain_move_to_pose((-24.0, -15.0, 0.0), (0.75, 0.75));
    sawp.add_action(Action::ToggleMatchload, 7.0);
    sawp.chain_move_to_pose((-24.0, 12.0, 0.0), (0.75, 1.0));

...
use crate::{SimDevice, state_cell};

use vex_sdk::{V5_Device, V5_DeviceT};
pub use vex_sdk::{
...
pub extern "C" fn vexDeviceMotorActualVelocityGet(device: V5_DeviceT) -> c_double {
    unsafe {
        let device_ptr_ptr = device as *mut *mut SimDevice;
        let device_ptr = *device_ptr_ptr;
        let device_obj = (&mut *device_ptr);
        core::mem::transmute_copy(&device_obj.data_out[1])
    }
}
#[unsafe(no_mangle)]
...
pub extern "C" fn vexDeviceMotorReverseFlagSet(device: V5_DeviceT, reverse: bool) {
    unsafe {
        ...
        let device_ptr = *device_ptr_ptr;
        let device_obj = (&mut *device_ptr);
        device_obj.data_in[0] = if reverse { 1 } else { 0 };
    }
}
#[unsafe(no_mangle)]
...
pub extern "C" fn vexDeviceMotorPositionSet(device: V5_DeviceT, position: c_double) {
    unsafe {
        ...
        let device_ptr = *device_ptr_ptr;
        let device_obj = (&mut *device_ptr);
        device_obj.data_out[0] = core::mem::transmute_copy(&position);
    }
}
#[unsafe(no_mangle)]
pub extern "C" fn vexDeviceMotorPositionGet(device: V5_DeviceT) -> c_double {
    unsafe {
        ...
        let device_ptr = *device_ptr_ptr;
        let device_obj = (&mut *device_ptr);
        core::mem::transmute_copy(&device_obj.data_out[0])
    }
}
#[unsafe(no_mangle)]
...
pub extern "C" fn vexDeviceMotorVoltageSet(device: V5_DeviceT, voltage: i32) {
    unsafe {
        ...
        let device_ptr = *device_ptr_ptr;
        &mut *device_ptr
    }.data_in[2] = unsafe { core::mem::transmute_copy(&(voltage as i64)) };
}
#[unsafe(no_mangle)]
pub extern "C" fn vexDeviceMotorVoltageGet(device: V5_DeviceT) -> i32 {
    unsafe {
        ...
        let device_ptr = *device_ptr_ptr;
        let device_obj = (&mut *device_ptr);
        core::mem::transmute_copy::<u64, i64>(&device_obj.data_in[2]) as i32
    }
}
#[unsafe(no_mangle)]
...
pub extern "C" fn vexDeviceMotorVoltageLimitSet(device: V5_DeviceT, limit: i32) {
    unsafe {
        let device_ptr = *device as *mut SimDevice;
        (&mut *device_ptr)
    }.data_in[3] = unsafe { core::mem::transmute_copy(&(limit as i64))};
}
#[unsafe(no_mangle)]
pub extern "C" fn vexDeviceMotorVoltageLimitGet(device: V5_DeviceT) -> i32 {
    unsafe {
        let device_ptr = *device as *mut SimDevice;
        let device_obj = (&mut *device_ptr);
        core::mem::transmute_copy::<u64, i64>(&device_obj.data_in[3]) as i32
    }
}
#[unsafe(no_mangle)]
